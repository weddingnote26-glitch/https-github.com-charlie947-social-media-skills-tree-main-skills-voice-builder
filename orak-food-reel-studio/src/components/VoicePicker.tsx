...
export default function VoicePicker({
  ...
  if (loading) return <div className="text-sm text-gray-600 py-4">목소리 목록을 불러오는 중…</div>;
  ...
  if (error || !data?.ready) {
    return (
      <div className="space-y-3">
        ...
        <button className="btn-secondary" onClick={reload}>다시 불러오기</button>
      </div>
    );
  }
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button className="btn-ghost" onClick={() => setManual((m) => !m)}>
              ...
              <div key={v.id}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-1 shrink-0" onClick={(e) => e.stopPropagation()}>
                    ...
                    <button className="btn-ghost" disabled={busy === v.id}
