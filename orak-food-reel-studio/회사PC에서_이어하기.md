...
2. orak-food-reel-studio/ 에서 npm install → npm run doctor → npm run test 로 34개 테스트가 통과하는지 확인
3. WORKLOG.md 최신 항목과 orak-food-reel-studio/README.md 를 읽고 현재 상태 파악
